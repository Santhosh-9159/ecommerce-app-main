...
const HomeScreen = () => {
  ...
  const images = [
    "https://d3vlhkqyz4y38a.cloudfront.net/media/offerImage/phpo2SUmu_1640015367.png",
  ...
  const fetchAddresses = async () => {
    try {
      const response = await axios.get(
        `http://192.168.0.230:8000/addresses/${userId}`
      );
        ...
        <ScrollView>
          ...
          >
            ...
            >
              ...
              onPress={()=>navigation.navigate("Search")}><Text>Search products</Text>
              </Pressable>
